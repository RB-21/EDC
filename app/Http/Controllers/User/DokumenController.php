...
class DokumenController extends Controller
{
    public function index(){
        ...
        return view('user.dokumen.index', compact('master_jenis_file','master_bagian', 'master_user_level', 'master_jenis_aksi'));
    }
    ...
    public function index_by_jenis($jenis_file, $bagian = null){
        ...
        return view('user.dokumen.index_by_jenis', compact('jenis_file','bagian', 'jenis_aksi'));
    }
    ...
    public function tampil(Request $request){
        ...
        return view('user.pdfjs.template', compact('path', 'judul'));
    }
    ...
    public function loadDokumen(Request $request){
