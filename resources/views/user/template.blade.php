      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item {{ Route::currentRouteName() == 'user.dokumen.index' ? 'active' : '' }}">
                <a href="{{route('user.dokumen.index') }}" class="nav-link"><i class="fas fa-file"></i><span>Master Dokumen</span></a>
              </li>
                @php
               ...
               @endphp
                ...
                @if ($item->has_sub == true)
                    <li class="nav-item dropdown {{ Route::currentRouteName() == 'user.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode ? 'active' : '' }}">
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($master_bagian_kandir as $item2)
                                <li class="{{ Route::currentRouteName() == 'user.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode && $bagian->kode_bagian == $item2->kode_bagian ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('user.dokumen.index_by_jenis', [$item->kode, $item2->kode_bagian]) }}">{{ $item2->kode_bagian }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                ...
                <li class="nav-item  {{ Route::currentRouteName() == 'user.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('user.dokumen.index_by_jenis', [$item->kode, null]) }}">
            ...
            @endforeach
              ...
              <li class="nav-item {{ Route::currentRouteName() == 'user.user.index' ? 'active' : '' }}">
