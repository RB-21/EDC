        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="{{ route('tamu.profile.index') }}" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('tamu.index') }}">EDC</a>
          </div>
          <ul class="sidebar-menu">
              <li class="menu-header">Dashboard</li>
              <li class="nav-item {{ Route::currentRouteName() == 'tamu.index' ? 'active' : '' }}">
                <a href="{{route('tamu.index') }}" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a>
              </li>
              <li class="menu-header">Menu</li>
              <li class="nav-item {{ Route::currentRouteName() == 'tamu.dokumen.index' ? 'active' : '' }}">
                <a href="{{route('tamu.dokumen.index') }}" class="nav-link"><i class="fas fa-file"></i><span>Master Dokumen</span></a>
              </li>
                @php
               ...
               @endphp
                ...
                @if ($item->has_sub == true)
                    <li class="nav-item dropdown {{ Route::currentRouteName() == 'tamu.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode ? 'active' : '' }}">
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($master_bagian_kandir as $item2)
                                <li class="{{ Route::currentRouteName() == 'tamu.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode && $bagian->kode_bagian == $item2->kode_bagian ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('tamu.dokumen.index_by_jenis', [$item->kode, $item2->kode_bagian]) }}">{{ $item2->kode_bagian }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                ...
                <li class="nav-item  {{ Route::currentRouteName() == 'tamu.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('tamu.dokumen.index_by_jenis', [$item->kode, null]) }}">
            ...
            @endforeach
              ...
              <li class="nav-item {{ Route::currentRouteName() == 'tamu.tamu.index' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('tamu.tamu.index') }}">
