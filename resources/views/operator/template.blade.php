        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="{{ route('operator.profile.index') }}" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('operator.index') }}">EDC</a>
          </div>
          <ul class="sidebar-menu">
              <li class="menu-header">Dashboard</li>
              <li class="nav-item {{ Route::currentRouteName() == 'operator.index' ? 'active' : '' }}">
                <a href="{{route('operator.index') }}" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a>
              </li>
              <li class="menu-header">Menu</li>
              <li class="nav-item {{ Route::currentRouteName() == 'operator.dokumen.index' ? 'active' : '' }}">
                <a href="{{route('operator.dokumen.index') }}" class="nav-link"><i class="fas fa-file"></i><span>Master Dokumen</span></a>
              </li>
                @php
                    $master_jenis_file = \App\Models\MasterJenisFile::whereIn('kode', explode(',',auth()->user()->jenis_file))->lazy();
                    $master_bagian_kandir = \App\Models\MasterBagian::where('tipe', 'kandir')->get()
               @endphp
                @foreach ($master_jenis_file as $item)
                @if ($item->has_sub == true)
                    <li class="nav-item dropdown {{ Route::currentRouteName() == 'operator.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode ? 'active' : '' }}">
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($master_bagian_kandir as $item2)
                                <li class="{{ Route::currentRouteName() == 'operator.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode && $bagian->kode_bagian == $item2->kode_bagian ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('operator.dokumen.index_by_jenis', [$item->kode, $item2->kode_bagian]) }}">{{ $item2->kode_bagian }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                ...
                <li class="nav-item  {{ Route::currentRouteName() == 'operator.dokumen.index_by_jenis' && $jenis_file->kode == $item->kode ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('operator.dokumen.index_by_jenis', [$item->kode, null]) }}">
            ...
            @endforeach
              ...
              <li class="nav-item {{ Route::currentRouteName() == 'operator.operator.index' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('operator.operator.index') }}">
