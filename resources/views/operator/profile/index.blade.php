        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body p-3 pb-2">
                        <form action="{{ route('operator.profile.edit') }}" method="POST">
                            @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('operator.profile.edit-email') }}" method="POST">
                            @csrf
                            <div class="form-group">
                ...
                {{-- <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('operator.profile.edit-nohp') }}" method="POST">
                            @csrf
                            @php
                                $no_hp = !empty(auth()->user()->uBiasaDetail)  ? auth()->user()->uBiasaDetail->no_hp : '';
                            @endphp
                            <div class="form-group">
